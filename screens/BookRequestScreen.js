...
import {  View,  Text, TextInput,  KeyboardAvoidingView,  StyleSheet,  TouchableOpacity,
  ScrollView,  FlatList,  TouchableHighlight,  Alert,  Image,} from "react-native";
...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchbook(bookName,'AIzaSyDSzfSORqpMmvMHCysMJ1jUOjvqQoL49Z4')
  ...
  async getBooksFromApi(bookName) {
    ...
    if (bookName.length > 2) {
      var books = await BookSearch.searchbook(
        bookName,
        "AIzaSyDSzfSORqpMmvMHCysMJ1jUOjvqQoL49Z4"
      );
      this.setState({
